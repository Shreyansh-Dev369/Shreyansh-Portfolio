...
const projects: Project[] = [
  ...
  },
  {
    ...
    title: "PropIntel AI",
    description:
      "AI-powered real estate platform for property valuation, investment insights, and smart recommendations",
    problem:
      "Helps users make smarter property decisions through AI-driven valuations, market insights, and personalized recommendations",
    techStack: [
      "Next.js",
      "TypeScript",
      "Python",
