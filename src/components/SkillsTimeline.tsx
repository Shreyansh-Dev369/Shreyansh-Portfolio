...
const milestones: Milestone[] = [
  {
    ...
    description: "Built strong fundamentals in programming, algorithms, and problem-solving",
    skills: ["Python", "JavaScript", "DSA", "OOP", "Problem Solving"],
    icon: Terminal,
    level: 1,
  },
  {
    ...
    description: "Developed responsive and modern web applications using contemporary technologies",
  ...
  },
  {
    ...
    description: "Built scalable backend services and worked with databases and APIs",
    skills: ["FastAPI", "PostgreSQL", "Redis", "Authentication", "System Design"],
    icon: Database,
    level: 3,
  },
  {
    ...
    description: "Explored machine learning, predictive modeling, and data-driven systems",
    skills: ["Python", "Scikit-learn", "Pandas", "NumPy", "Feature Engineering"],
    icon: Brain,
    level: 4,
  },
  {
    ...
    description: "Building production-ready AI applications with machine learning and intelligent systems",
    skills: ["NLP", "XGBoost", "FastAPI", "AI Systems", "MLOps"],
    icon: Server,
    level: 5,
  },
];
